...
# window, never the sum (CLAUDE.md). t_back = 900 s eats the first half of the window, so
...
# last part is the trap in CLAUDE.md: the output test is `it % frqOutput == 0` on the
