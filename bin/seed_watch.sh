...
# THE CEILING THE RUN ACTUALLY HAS, NOT THE MANIFEST'S. Every seeds manifest carries
# steps_total = 349920 (3.0 sim-h) and SEED_CEILING_H -- 2.0 h by default -- is applied
# inside bin/run_seed.sh, which now exports the resulting step count. Without it this
