...
**But the LES-Kljun parity that justified accepting truncation does not hold at 3660 m.** The LES
...
the neutral flat control comes with that gap stated ([limitations](../limitations-and-future-work.md),
item 4).
...
2026-09-04 (in the offline pre-cleanup archive of 2026-09-04). The gate's logic is in
