...
`showcase_test.png` (cases 2025-05-31 15 N, 2025-02-09 06 NW, 2025-11-04 21 S, 2025-04-20 16 E, pinned with `--cases`; the picker's first choices were set aside on request, and row 3 was chosen as the S-sector case where the CFM leads on the most metrics), `generative_test.png` (2025-03-19 21, N, pinned with `--case`), `sectors_test.png`, `distributions_test.png`.
