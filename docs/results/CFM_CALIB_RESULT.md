...
`showcase_test.png` (cases 2025-05-31 15 N, 2025-02-09 06 NW, 2025-09-14 22 SE, 2025-04-20 16 E, pinned with `--cases`; the picker's first choices were set aside on request), `generative_test.png` (2025-03-19 21, N: the in-view N record where the CFM's crosswind profile beats the FNO's by the most, `--prefer-cfm-profile`), `sectors_test.png`, `distributions_test.png`.
