...
| term | meaning here |
|---|---|
| **array share** | the fraction of the footprint's (positive) mass that lies on the solar array's 44 cells. The site-specific quantity the emulator exists to get right. Quoted in percentage points (pp) |
