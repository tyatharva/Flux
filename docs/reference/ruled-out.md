...
| A neutral well-mixed PASS as evidence about the convective closure | The floor is nearly inert neutrally. It passed a closure carrying nine turnovers. |
...
| CONUS404 as a forcing | It sets sweep ranges and is the 45-year climatology the site is characterised by. HRRR forces the runs. |
