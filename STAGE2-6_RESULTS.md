...
**Solar array**, per CLAUDE.md's bulk-patch specification: `z0` 0.03 -> 0.20 m over a
...
geometry, per CLAUDE.md: row spacing is ~5-7 m and a 30 m grid cannot resolve it.
