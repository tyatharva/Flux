...
The short forms live in `CLAUDE.md`; this file carries the diagnosis and the evidence.
...
Documented in `CLAUDE.md`; repeated here because trap 1 is its sharper form. A fully-NaN
