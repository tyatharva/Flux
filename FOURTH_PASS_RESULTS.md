...
**The array multiplier retires an accepted omission.** PROJECT_BRIEF.md lists the elevated heat
...
PROJECT_BRIEF.md identifies for albedo: with no radiation scheme, `htFlux` is what albedo would
